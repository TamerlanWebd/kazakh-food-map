...
export default function KazakhFoodMap() {
  ...
  return (
    <main
      className={`min-h-screen transition-all duration-500 ${themeClasses} overflow-x-hidden font-sans ornament-grid`}
    >
      ...
      <header
        className={`relative z-20 px-4 py-6 md:px-8 md:py-10 transition-colors duration-500 ${isBoardMode ? "bg-black/40 border-b border-white/5" : "bg-white border-b-4 border-white"} backdrop-blur-2xl`}
      >
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-8">
          ...
          >
            <div
              className={`flex items-center gap-3 text-sm font-black uppercase tracking-[0.3em] ${isBoardMode ? "text-amber-500" : "text-amber-600"}`}
            >
              <Sparkles size={20} className="animate-pulse" />{" "}
              <span>National Gastronomic Heritage</span>
            </div>
            <h1 className="mt-2 text-3xl sm:text-5xl md:text-6xl font-black tracking-tighter leading-none premium-text-glow">
              Өңір дәмдері
            </h1>
            <p className="mt-2 text-lg md:text-xl font-medium opacity-60 italic">
              Интерактивное путешествие по вкусам Казахстана
            </p>
          </motion.div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6">
            ...
            <button
              ...
              className={`flex items-center gap-2 md:gap-3 rounded-xl md:rounded-2xl px-4 py-3 md:px-8 md:py-4 text-sm md:text-lg font-black transition-all shadow-xl border-4 ${
                isBoardMode
            ...
            >
              {isBoardMode ? (
                ...
                <MapIcon className="w-4 h-4 md:w-6 md:h-6" />
              )}
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 py-8 md:py-12 relative z-10 space-y-12 md:space-y-16">
        ...
        <section
          className={`rounded-[30px] md:rounded-[60px] px-2 py-6 sm:p-8 md:p-12 relative overflow-hidden flex flex-col items-center border-4 ${isBoardMode ? "glass-card border-white/10" : "bg-white border-white shadow-2xl"}`}
        >
          ...
          <div className="relative w-full h-[350px] sm:h-[500px] md:h-[700px] flex items-center justify-center mt-16 md:mt-12 cursor-default">
            <svg
              ...
              className="w-full h-full drop-shadow-[0_0_50px_rgba(0,0,0,0.5)]"
            >
              <g>
                {geoData.features.map((feature: Adm1Feature, idx: number) => {
          ...
          <div
            className={`mt-8 md:mt-12 flex items-center gap-3 md:gap-4 px-6 md:px-10 py-4 md:py-5 rounded-3xl md:rounded-full border-2 ${isBoardMode ? "glass-card border-white/5" : "bg-gray-100 border-gray-200"}`}
          >
            <Info className="text-amber-500 animate-bounce shrink-0 w-5 h-5 md:w-6 md:h-6" />
            <span className="text-sm md:text-lg font-bold opacity-80 italic">
              Выберите регион, чтобы погрузиться в его гастрономическую
              историю...
            </span>
          </div>
        </section>
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-12">
            <motion.section
              ...
              className={`rounded-[40px] md:rounded-[60px] p-8 sm:p-12 md:p-16 border-4 relative overflow-hidden ${
                isBoardMode
                  ? "bg-amber-500 text-white border-amber-400/50 shadow-2xl shadow-amber-500/20"
            ...
            >
              ...
              <h2 className="text-2xl sm:text-6xl md:text-7xl font-black tracking-tighter premium-text-glow">
                {activeRegion.title}
              </h2>
              <p
                className={`mt-2 md:mt-4 text-xl sm:text-2xl md:text-3xl font-bold italic ${isBoardMode ? "text-amber-100" : "text-amber-700"}`}
              >
                {activeRegion.subtitle}
              </p>
              <div
                className={`mt-8 md:mt-12 p-6 md:p-10 rounded-[30px] md:rounded-[40px] border-2 border-dashed ${isBoardMode ? "bg-black/20 border-white/10" : "bg-gray-50 border-gray-200"}`}
              >
                <p className="text-lg md:text-2xl leading-relaxed italic opacity-95">
            ...
            <div
              className={`rounded-[40px] md:rounded-[60px] p-8 md:p-12 border-4 ${isBoardMode ? "glass-card border-white/5" : "bg-white border-white shadow-2xl"}`}
            >
              ...
              <div className="flex flex-col xl:flex-row items-center gap-8 md:gap-16">
                <div className="relative group scale-90 sm:scale-100">
                  ...
                  <RadarChart
                    profile={activeRegion.tasteProfile}
                    isDark={isBoardMode}
                  />
                </div>
                <div className="space-y-6 md:space-y-8 flex-1">
                  <p
                    className={`text-lg md:text-2xl font-medium leading-relaxed ${isBoardMode ? "text-gray-300" : "text-gray-600"}`}
                  >
                    {activeRegion.mainHighlight}
                  </p>
                  <div className="grid grid-cols-2 gap-4 md:gap-6">
                    <div
                      className={`p-4 md:p-6 rounded-2xl md:rounded-3xl border-2 flex flex-col justify-center gap-1 ${isBoardMode ? "glass-card border-white/5" : "bg-gray-50 border-gray-100"}`}
                    >
          ...
          {/* Gastronomy & Drinks */}
          <div
            className={`rounded-[40px] md:rounded-[60px] p-8 md:p-16 border-4 liquid-effect flex flex-col ${isBoardMode ? "glass-card border-white/5" : "bg-white border-white shadow-2xl"}`}
          >
            <div className="flex items-center gap-4 md:gap-6 mb-10 md:mb-16">
              ...
              <h3 className="text-2xl md:text-6xl font-black tracking-tighter">
                Гастрономия
              </h3>
            </div>
            ...
            <div className="flex-1 space-y-20">
              <section>
                <div className="flex items-center justify-between mb-6 md:mb-8">
                  <h4
                    className={`text-lg md:text-2xl font-black uppercase tracking-widest ${isBoardMode ? "text-amber-400" : "text-amber-600"}`}
                  >
                    🥘 Фирменные Блюда
                  </h4>
                  <span className="text-[10px] font-bold opacity-30 uppercase hidden sm:inline">
                    Нажми для деталей
                  </span>
                </div>
                  ...
                  {activeRegion.dishes.map((dishName, i) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className={`flex items-center justify-between p-4 md:p-7 rounded-2xl md:rounded-[32px] border-2 cursor-pointer transition-all ${
                          isBoardMode
              ...
              <section className="relative">
                <div className="flex items-center gap-4 mb-8 md:mb-10">
                  <h4
                    className={`text-lg md:text-2xl font-black uppercase tracking-widest ${isBoardMode ? "text-blue-400" : "text-blue-600"}`}
                  >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  {activeRegion.drinks.map((drink, i) => (
                    <motion.div
                      ...
                      className={`p-6 md:p-8 rounded-[30px] md:rounded-[40px] border-4 relative overflow-hidden group cursor-pointer transition-all ${
                        isBoardMode
                    ...
                    >
                      <div className="absolute -right-4 -bottom-4 opacity-10 group-hover:opacity-20 transition-opacity grayscale group-hover:grayscale-0 duration-700">
                        <Image
                          src={
                            drink.iconType === "milk"
                              ? "/images/icons/kumis.png"
                              : drink.iconType === "tea"
                                ? "/images/icons/tea.png"
                                : "/images/icons/ayran.png"
                          }
                          alt=""
                          width={150}
                          height={150}
                      ...
                      <div className="relative z-10 space-y-3 md:space-y-4">
                        <div className="flex items-center gap-3 md:gap-4">
                          <div
                            className={`p-3 md:p-4 rounded-xl md:rounded-2xl ${isBoardMode ? "bg-white/5 border border-white/10" : "bg-blue-50 border border-blue-100"}`}
                          >
                            <Image
                              src={
                                drink.iconType === "milk"
                          ...
                          <h5 className="text-xl md:text-2xl font-black">
                            {drink.name}
                          </h5>
                        </div>
        ...
        <section className="pt-10 md:pt-20">
          <div className="flex items-center gap-6 md:gap-10 mb-12 md:mb-20 px-4 md:px-8">
            <h2 className="text-2xl sm:text-5xl md:text-7xl font-black tracking-tighter uppercase premium-text-glow text-balance">
              Визитные карточки
            </h2>
          ...
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
            {activeRegion.featuredDishSlugs.map((slug) => {
              ...
              return (
                <motion.div
                  ...
                  className={`rounded-[30px] md:rounded-[50px] overflow-hidden border-4 h-full flex flex-col cursor-pointer transition-all ${
                    isBoardMode
                ...
                >
                  <div className="relative h-64 md:h-80 w-full group">
                    ...
                    <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10 text-white">
                      ...
                      <h4 className="text-2xl md:text-4xl font-black leading-none">
                        {dish.name}
                      </h4>
                    </div>
                  </div>
                  <div className="p-8 md:p-12 flex-1 flex flex-col justify-between space-y-6 md:space-y-8">
                    <p
                      className={`text-base md:text-xl leading-relaxed opacity-70 ${isBoardMode ? "text-gray-300" : "text-gray-600"}`}
                    >
      ...
      <footer
        className={`mt-20 md:mt-40 py-12 md:py-24 text-center border-t-4 relative z-20 ${
          isBoardMode
            ? "border-white/5 bg-black/60 text-white/40"
            : "border-white bg-white text-gray-500 shadow-[0_-20px_50px_rgba(0,0,0,0.1)]"
        }`}
      >
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col items-center gap-6 md:gap-8">
            <div className="flex items-center gap-3 text-xl md:text-2xl font-black uppercase tracking-[0.4em] text-amber-500 mb-2 md:mb-4">
              ...
              <span>Өңір дәмдері</span>
            </div>
            <p className="text-lg md:text-2xl font-medium max-w-2xl leading-relaxed text-balance">
              © 2026 — Премиальная интерактивная гастрономическая карта
              Казахстана. Разработано специально для национальных павильонов и
              презентаций.
            </p>
